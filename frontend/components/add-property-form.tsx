        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2">
          ...
          <label className="block space-y-2 sm:col-span-2">
            ...
            <p className="text-sm text-[color:var(--muted)]">
              Uploaded files now go to configured cloud storage. If no cloud
              images are attached, GMT Homes falls back to the curated property
              photography already in the catalog.
            </p>
          </label>
        </div>
      ...
      <aside className="space-y-6">
        <section className="rounded-[2rem] border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-[var(--shadow-card)] sm:p-8">
          ...
          <div className="mt-5 space-y-4 text-sm leading-7 text-[color:var(--foreground)]">
            ...
            <p>Listings enter moderation before they appear in the public catalog.</p>
          </div>
        </section>
